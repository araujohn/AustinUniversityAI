...
set_body(S[5].shapes[1].text_frame, [
    ...
    ("Pipeline: OneHotEncoder(handle_unknown='ignore') for categoricals + passthrough numerics, fused with each model.", 1),
    ("80/20 train-test split (7,010 train / 1,753 test), random_state = 1.", 1),
])
